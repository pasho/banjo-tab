...
export const ThoseWereTheDays = () => (
  <>
    <h1>Those were the days (Dorogoy Dlinnoyu)</h1>
    <h2>Clawhammer Banjo arrangement</h2>
    <p>f#DGBd</p>
    <VexTabSheet
      {...{
        time: "4/4",
        tuning: "D/5,B/4,G/4,D/4,F#/5",
        staves: [
          `
          ...
          `,
          `
            notes :q 4/4 :8 (4/1.3/2.2/3.4/4)-0/5 ## 0/4 2h4/4 |
...
export const ThoseWereTheDaysSimple = () => (
  <>
    <h1>Those were the days (Dorogoy Dlinnoyu)</h1>
    <h2>Simple arrangement</h2>
    <p>f#DGBd</p>
    <VexTabSheet
      {...{
        time: "4/4",
