  ...
  <>
    ...
    <VexTabSheet
      {...{
        ...
        staves: [
          `
            notes :hd (2/1.1/2.0/3.0/4) :8 ## 0/3 =|: 1/2-0/5 0h2/3 0/2-0/5 4-4/4 | 2/3-0/5 0/3-5/4 0/3-0/5 0-0/4 |
            notes 2/4-0/5 2s4/4 5/4-0/5 5/4-0/3 $.top.P, $ | 2/3-0/5 0h1/2 (0/1.0/2.0/3.2/4)-0/5 ## 0/3 |
          `,
          `
            notes :8 2/1-0/5 0/1-1/2 0/1-0/5 0/2-0/3 | 1/2-0/5 0/2-2/3 0/2-0/5 4-4/4 | 2/3-0/5 0/3-5/4 0/3-0/5 0-0/4 |
            notes 1/2-0/5 0/2-2/3 0/3-0/2 $.top.P, $ 1h3/2 | :q 2/1 :8 (2/1.1/2.0/3.0/4)-0/5 0/1-1/2 0h1/2 |
          `,
          `
            notes :q 0/1 :8 (0/1.0/2.0/3.2/4)-0/5 0/3-0/2 $.top.P, $ 1h3/2 | :q 1/2 :8 (2/1.1/2.0/3.0/4)-0/5 0/2-2/3 0h2/3 |
            notes :q 0/1 :8 (0/1.0/2.0/3.2/4)-0/5 4/4-0/3 $.top.P, $ 2/3-0/2 $.top.P, $ | 
            notes 1/2-0/5 2/3-0/2 $.top.P, $ 1/2-0/5 2/3-0/2 $.top.P, $ | 1/2-0/5 2/3-1/2 :q 3/1 :8 (3/1.1/2.2/3.0/4)-0/5 |
          `,
          `
            notes :q 3/1 :8 (3/1.1/2.2/3.0/4)-0/5 2p0/1 1p0/2 | :q 2/1 :8 (2/1.1/2.0/3.0/4)-0/5 :q 1/2 :8 (2/1.1/2.0/3.0/4)-0/5 |
            notes :q 0/1 :8 (0/1.0/2.0/3.2/4)-0/5 1p0/2 2p0/3 | :q 1/2 :8 (2/1.1/2.2/3.0/4)-0/5 :q 2/3 :8 (2/1.1/2.2/3.0/4)-0/5 |
            notes 1/2-0/5 0/2-2/3 0/3-0/5 0-0/4 |
          `,
          `
            notes 1/2-0/5 0/2-2/3 0/3-0/5 ## 0/3 =:| :q 0/3 (0/1.0/2.0/3.2/4) 2/3 0/2 | :w (2/1.1/2.0/3.0/4) =||
            text .-1,:w,1.,|2.
          `,
        ],
      }}
